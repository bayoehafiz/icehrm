...
--
-- Truncate table before insert `Benifits`
--

TRUNCATE TABLE `Benifits`;
--
...
--
-- Truncate table before insert `Calls`
--
...
--
-- Truncate table before insert `CompanyDocuments`
--
...
(1, 'Razorfish', 'Head company', '', 'Company', 'ID', NULL, 'Asia/Jakarta', '[\"1\"]'),
(2, 'Solutions', 'Menara Thamrin', '', 'Regional Office', 'ID', 1, 'Asia/Jakarta', '[]'),
(3, 'Star Reachers', 'Gedung Jamsostek', '', 'Regional Office', 'ID', 1, 'Asia/Jakarta', '[]');
...
--
-- Truncate table before insert `ConversationUserStatus`
--

TRUNCATE TABLE `ConversationUserStatus`;
-- --------------------------------------------------------
...
(1, 'C0001', 'Info Marketing', 'Learn how to Create and Outsource Info Marketing Products', 1, 'Tim Jhon', 'Tim Jhon has a background in business management and has been working with small business to establish their online presence', 'Company Sponsored', 'USD', '55.00', 'Active', '2018-10-29 10:38:15', '2018-10-29 10:38:15'),
(2, 'C0002', 'People Management', 'Learn how to Manage People', 1, 'Tim Jhon', 'Tim Jhon has a background in business management and has been working with small business to establish their online presence', 'Company Sponsored', 'USD', '59.00', 'Active', '2018-10-29 10:38:15', '2018-10-29 10:38:15');
...
--
-- Truncate table before insert `Crons`
--
...
(2, 'Document Expire Alert', 'DocumentExpiryNotificationTask', NULL, 1, '10', 'Hourly', 'Enabled');
...
--
-- Truncate table before insert `CustomFieldValues`
--
...
(1, 'User', 'csrf', '1', '97084677cb64170874a3d264cfbb698c0b5bca9a', '2018-10-29 09:22:57', '2018-10-29 09:22:57');
...
--
-- Truncate table before insert `DataImport`
--
...
--
-- Truncate table before insert `DataImportFiles`
--

TRUNCATE TABLE `DataImportFiles`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `DeductionGroup`
--

TRUNCATE TABLE `DeductionGroup`;
-- --------------------------------------------------------
...
(1, 'ID Copy', 'Your ID copy', 'Yes', 'Yes', 'Yes', 'Yes', 'No', NULL, '2018-10-29 10:38:15', '2018-10-29 10:38:15'),
(2, 'Degree Certificate', 'Degree Certificate', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', NULL, '2018-10-29 10:38:15', '2018-10-29 10:38:15'),
(3, 'Driving License', 'Driving License', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', NULL, '2018-10-29 10:38:15', '2018-10-29 10:38:15');
...
--
-- Truncate table before insert `EducationLevel`
--

TRUNCATE TABLE `EducationLevel`;
--
...
--
-- Truncate table before insert `EmployeeApprovals`
--

TRUNCATE TABLE `EmployeeApprovals`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `EmployeeAttendanceSheets`
--

TRUNCATE TABLE `EmployeeAttendanceSheets`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `EmployeeDataHistory`
--

TRUNCATE TABLE `EmployeeDataHistory`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `EmployeeExpenses`
--

TRUNCATE TABLE `EmployeeExpenses`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `EmployeeForms`
--

TRUNCATE TABLE `EmployeeForms`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `EmployeeLeaveDays`
--

TRUNCATE TABLE `EmployeeLeaveDays`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `EmployeeLeaveLog`
--

TRUNCATE TABLE `EmployeeLeaveLog`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `EmployeeOvertime`
--

TRUNCATE TABLE `EmployeeOvertime`;
-- --------------------------------------------------------
...
(1, 'EMP001', 'Super', '', 'Admin', 83, '1984-03-17', 'Male', 'Married', '', '294-38-3535', '294-38-3535', '', NULL, 3, 11, 2, '', 'Jln. Pahlawan 101', '', 'Surabaya', 'ID', NULL, '60129', '', '440-953-4578', '440-953-4578', 'bayu.hafiz@gmail.com', 'bayu.hafiz@gmail.com', '2005-08-03', NULL, NULL, '[]', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'Active', NULL, NULL, NULL, NULL, NULL);
...
(1, 1, '2018-10-28', '2018-11-03', 'Pending');
...
--
-- Truncate table before insert `EmployementType`
--

TRUNCATE TABLE `EmployementType`;
--
...
--
-- Truncate table before insert `ExpensesCategories`
--

TRUNCATE TABLE `ExpensesCategories`;
--
...
--
-- Truncate table before insert `ExpensesPaymentMethods`
--

TRUNCATE TABLE `ExpensesPaymentMethods`;
--
...
--
-- Truncate table before insert `ExperienceLevel`
--
...
--
-- Truncate table before insert `Interviews`
--
...
--
-- Truncate table before insert `JobFunction`
--

TRUNCATE TABLE `JobFunction`;
--
...
--
-- Truncate table before insert `LeaveGroupEmployees`
--

TRUNCATE TABLE `LeaveGroupEmployees`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `LeaveGroups`
--

TRUNCATE TABLE `LeaveGroups`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `LeavePeriods`
--

TRUNCATE TABLE `LeavePeriods`;
--
...
--
-- Truncate table before insert `LeaveRules`
--

TRUNCATE TABLE `LeaveRules`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `LeaveStartingBalance`
--

TRUNCATE TABLE `LeaveStartingBalance`;
-- --------------------------------------------------------
...
(1, 'v20161116_190001_unique_index_cron_name.php', 190001, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(2, 'v20170310_190401_add_timesheet_changes.php', 190401, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(3, 'v20170702_190500_add_attendance_image.php', 190500, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(4, 'v20170908_200000_payroll_group.php', 200000, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(5, 'v20170918_200000_add_attendance_image_out.php', 200000, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(6, 'v20171001_200201_update_attendance_out.php', 200201, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(7, 'v20171003_200301_add_deduction_group_payroll.php', 200301, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(8, 'v20171003_200302_payroll_meta_export.php', 200302, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(9, 'v20171126_200303_swift_mail.php', 200303, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(10, 'v20180305_210100_drop_si_hi_languages.php', 210100, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(11, 'v20180317_210200_leave_rule_experience.php', 210200, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(12, 'v20180325_210101_delete_leave_group_employee.php', 210101, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(13, 'v20180417_210501_update_menu_names.php', 210501, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(14, 'v20180507_230001_update_travel_record_type.php', 230001, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(15, 'v20180514_230002_add_conversation_tables.php', 230002, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(16, 'v20180527_230003_update_menu_names.php', 230003, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(17, 'v20180602_230004_add_gsuite_fields.php', 230004, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(18, 'v20180615_230402_remove_eh_manager.php', 230402, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(19, 'v20180622_240001_set_valid_until_null.php', 240001, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL),
(20, 'v20180623_240002_update_employee_report.php', 240002, '2018-10-29 09:08:41', '2018-10-29 09:08:41', 'Up', NULL);
...
--
-- Truncate table before insert `OvertimeCategories`
--

TRUNCATE TABLE `OvertimeCategories`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `PayFrequency`
--

TRUNCATE TABLE `PayFrequency`;
--
...
--
-- Truncate table before insert `Payroll`
--
...
--
-- Truncate table before insert `PayrollColumns`
--

TRUNCATE TABLE `PayrollColumns`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `PayrollColumnTemplates`
--

TRUNCATE TABLE `PayrollColumnTemplates`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `PayrollData`
--

TRUNCATE TABLE `PayrollData`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `PayrollEmployees`
--

TRUNCATE TABLE `PayrollEmployees`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `PayslipTemplates`
--

TRUNCATE TABLE `PayslipTemplates`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `ReportFiles`
--

TRUNCATE TABLE `ReportFiles`;
-- --------------------------------------------------------
...
(1, 1, 'c589609414f08e0c2c5a65657b35636b', 'MQDKX8GA1lsoRcAuTaQgrj/Vmk749y8VLjqSflZCSBTYKvKahBsWNlstwbli/y2YwDY3A7ALim4w9dZeW1bNex9VcUuIfQ==', '2018-10-29 09:08:41', '2018-10-29 09:08:41');
...
(55, 'Instance : ID', 'cbcbc844a9e79c1c0e26ab1962fdf83f', NULL, NULL),
(56, 'Instance: Key', 'bAGeNpqB1lv0A8VAyc4C1a695QeDNXn5sspY0s//E34DlS6GdhHmbvmGlfjVCPA=', NULL, NULL),
(57, 'Modules : Group', 'all', 'all', '');
...
--
-- Truncate table before insert `StatusChangeLogs`
--

TRUNCATE TABLE `StatusChangeLogs`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `SupportedLanguages`
--

TRUNCATE TABLE `SupportedLanguages`;
--
...
--
-- Truncate table before insert `Timezones`
--
...
--
-- Truncate table before insert `UserReports`
--

TRUNCATE TABLE `UserReports`;
--
...
(1, 'admin', 'bayu.hafiz@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 1, NULL, 'Admin', '[]', '2018-10-29 09:15:34', NULL, NULL, NULL, 1, NULL);
...
--
-- Truncate table before insert `WorkDays`
--

TRUNCATE TABLE `WorkDays`;
--
